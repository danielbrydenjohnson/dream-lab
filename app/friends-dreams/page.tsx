...
function FriendsDreamsPageInner() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        {/* Content */}
        <section className="rounded-2xl border border.white/10 border-white/10 bg-slate-950/80 backdrop-blur-md p-5 sm:p-6 shadow-lg shadow-black/40">
          {loading ? (
